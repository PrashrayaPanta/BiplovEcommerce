...
export default function ProductGallery({
  ...
  return (
    <div
      className={cn("relative flex flex-col md:flex-row gap-4 mb-6", className)}
    >
      {/* Main Carousel */}
      <div className="relative flex-1 order-1 md:order-2">
        ...
        <Dialog className="">
          <DialogTrigger asChild>
            ...
            >
              <Expand className="h-10 w-4" />
            </Button>
          </DialogTrigger>
          <DialogContent className="p-0">
            <img
              src={
                images?.[selectedIndex]?.public_id
                  ? imgUrl(images[selectedIndex].public_id)
                  : "/placeholder.svg"
              }
