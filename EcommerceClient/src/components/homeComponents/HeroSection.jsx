...
function HeroSection() {
  return (
    <div 
      className="w-full h-[1/2vw] bg-cover bg-center flex items-center max-h-[28rem] min-h-[24rem] mt-20" 
    ...
    >
      <div className="lg:w-1/2 md:p-24 w-3/4 p-6">
        <h1 className="xl:text-6xl text-4xl  font-bold">Step into the world of Audiophile with KZ-EDX Pro IEM</h1>
